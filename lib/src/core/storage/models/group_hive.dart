...
/// Hive type ID for Group - extends the HiveTypeIds range.
/// Using 10 to leave room for future core types.
const int hiveTypeIdGroup = 10;

/// Hive-compatible group model.
@HiveType(typeId: hiveTypeIdGroup)
